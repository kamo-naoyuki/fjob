...
var cliCommandSpecs = []cliCommandSpec{
	...
	},
	{
		...
		Usage:       "rotari change [--basedir DIR] [--project-name NAME] [--run-id ID] [--job-id ID|--job-name NAME] [--executor EXECUTOR] [--executor-option OPTION] [--clear-executor-options] [--env KEY=VALUE] [--clear-env] [--set-job-name NAME] [--depends-on NAME] [--clear-depends-on] [-- command ...]",
		Flags: append(commonCLIFlags(),
	...
	},
	{
		...
		Usage:       "rotari add [--basedir DIR] [--project-name NAME] [--executor EXECUTOR] [--executor-option OPTION] [--env KEY=VALUE] [--job-name NAME] [--depends-on NAME] [--array FIRST-LAST] [--run] <command ...>",
		Flags: append(commonCLIFlags(),
