...
var cliCommandSpecs = []cliCommandSpec{
	...
	},
	{
		...
		Usage:       "fjob change [--basedir DIR] [--queue-name NAME] [--run-id ID] [--job-id ID|--job-name NAME] [--backend BACKEND] [--sbatch-option OPTION] [--clear-sbatch-options] [--set-job-name NAME] [--depends-on NAME] [--clear-depends-on] [-- command ...]",
		Flags: append(commonCLIFlags(),
			...
			cliFlagSpec{Name: "backend", Description: "replace job backend", ValueName: "BACKEND", Values: []string{"local", "slurm"}},
			cliFlagSpec{Name: "sbatch-option", Description: "replace Slurm options", ValueName: "OPTION"},
			cliFlagSpec{Name: "clear-sbatch-options", Description: "clear Slurm options"},
	...
	},
	{
		...
		Usage:       "fjob show [--basedir DIR] [--queue-name NAME] [--run-id ID] [--job-id ID] [--failed] [--logs] [--failed-logs] [--no-pager] [--runs]",
		Flags: append(commonCLIFlags(),
	...
	},
	{
		...
		Usage:       "fjob submit [--basedir DIR] [--queue-name NAME] [--backend BACKEND] [--sbatch-option OPTION] [--job-name NAME] [--depends-on NAME] <command ...>",
		Flags: append(commonCLIFlags(),
